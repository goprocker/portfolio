...
`,
  ...
  collabs: [
    { id: "responsesync", partner: "RushHour Hackathon (Team: Adengappa Aru Peru)", partnerType: "Hackathon Project", title: "ResponSync", role: "Team Builder", period: "2026", status: "COMPLETED", description: "A three-agent Gemini-powered pipeline built at RushHour Hackathon by team Adengappa Aru Peru for real-time flood response coordination in Chennai. Placed fourth with a special mention and led to an internship offer from Astra Dyne Global.", contributions: ["Designed a multi-agent flood-response workflow.", "Built real-time coordination tooling for urgent response."], techStack: ["Gemini API", "Python", "Agentic Workflows"], link: "https://responsesync.ai.studio/", asciiLogo: "[ RESPONSYNC ]\nFlood response, coordinated." },
    { id: "sist-form", partner: "Independent Project", partnerType: "Independent", title: "SIST Event Form Maker", role: "Solo Developer", period: "2026", status: "COMPLETED", description: "An independent form-builder tool for Sathyabama event management, created with Lovable.", contributions: ["Built an accessible event form creation flow.", "Delivered a no-code operations tool."], techStack: ["Lovable", "No-code AI"], link: "https://sisteventformmaker.lovable.app/", asciiLogo: "[ SIST ]\nEVENT FORM MAKER" },
    { id: "p2pskill", partner: "WiCyS Sathyabama", partnerType: "WiCyS Tech Project", title: "P2PSkill", role: "Builder", period: "2025", status: "ONGOING", description: "A peer-to-peer skill-exchange platform developed as a WiCyS tech project for people who want to trade skills directly.", contributions: ["Built the full-stack exchange platform.", "Designed the user and matching experience."], techStack: ["React", "Node.js", "MongoDB", "Vercel", "Render"], asciiLogo: "[ P2P SKILL ]\nLearn. Trade. Grow." },
    { id: "dhc", partner: "DHC (Digital Horizon Conclave)", partnerType: "Event Website", title: "Digital Horizon Conclave 2026", role: "Solo Developer", period: "2026", status: "COMPLETED", description: "Official event website for the Digital Horizon Conclave (DHC 2026) national technical symposium spanning AI, gaming, XR, robotics, and IoT, with a dark futuristic visual system and a physics-based fluid hover-reveal hero.", contributions: ["Designed and built the event experience solo.", "Created a custom interactive WebGL hero."], techStack: ["Next.js 16", "React 19", "Tailwind 4", "Framer Motion", "WebGL"], link: "https://digital-horizon-conclave-2026.vercel.app/", asciiLogo: "[ DHC 2026 ]\nDIGITAL HORIZON" },
    { id: "conference", partner: "SIST", partnerType: "Template", title: "Conference Website Template", role: "Solo Developer", period: "2026", status: "COMPLETED", description: "A reusable conference website covering registration, submissions, committees, publications, schedules, and venue information.", contributions: ["Built a production-ready reusable template.", "Added polished scrolling and interaction design."], techStack: ["Next.js 16", "React 19", "Tailwind 4", "GSAP", "Lenis"], link: "https://sist-confdemo.vercel.app/", asciiLogo: "[ CONF TEMPLATE ]\nREADY TO DEPLOY" },
    { id: "habitloop", partner: "Ascend Event", partnerType: "Event Project", title: "HabitLoop", role: "Solo Developer", period: "2026", status: "COMPLETED", description: "A habit-tracking web app built for the Ascend event that helps people maintain daily habits through consistent check-ins.", contributions: ["Built the end-to-end habit tracking experience.", "Integrated Supabase for persistent user data."], techStack: ["React", "TypeScript", "Vite", "Supabase"], link: "https://habit-loop-seven.vercel.app/", asciiLogo: "[ HABIT LOOP ]\nCHECK IN. SHOW UP." },
  ] as CollabItem[],
